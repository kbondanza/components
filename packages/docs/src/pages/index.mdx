<Box pt="48px" px={8} pb="64px"
style={{backgroundImage: 'repeating-radial-gradient(ellipse at 10% -80%, #012e6f, #012e6f 20px, #012a66 20px, #012a66 50px)'}}>
...
<Box textAlign="center" maxWidth="600px" my={8} mx={'auto'}>

The [@matthamlin/components](https://github.com/hamlim/components) package
contains a few opinionated styled components built using React, Emotion, and
Styled-System.

</Box>

[![github](https://flat.badgen.net/badge/icon/github/black?icon=github&label)](https://github.com/hamlim/components)
...
<Box color="primary" m={[2, 4]}> Content </Box>
